...
function BoxMaDienThoai({showMaDienThoai,setShowMaDienThoai,getvaluePhoneCode}) {
            ...
            showMaDienThoai?(
                <div className='madienthoai'>
                    ...
                    <div className='option-list-mdt' >
                        ...
                        <span className="option-list-mdt-item" key={code.id} onClick={handlePhoneCode}>
                          <img src={code.imgNational} alt="" />{code.nation}({code.code})
                        </span>
