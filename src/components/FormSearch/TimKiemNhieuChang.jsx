...
import BoxPassenger from "./component/BoxPassenger/BoxPassenger";
import Provinces from "./component/Provinces/Provinces";
...
function TimKiemNhieuChang({setSendData}) {
  ...
  const handleOnchangeTimeTab1 = (date, dateString) =>
  setTimeTab1(dateString);
const handleOnchangeTimeTab2 = (date, dateString) =>
  setTimeTab2(dateString);
const handleOnchangeTimeTab3 = (date, dateString) =>
  setTimeTab3(dateString);
  ...
  const handleData = ()=>{
    ...
    return (
        <Fragment>
                            <div
          className={"formSearch-main active" }
        >
            ...
            <div className="part3">
              ...
              <div className="form-field">
                ...
                <DatePicker
                  ...
                  onChange={handleOnchangeTimeTab1}
                />
                <label htmlFor="name" className="form-label">
                  Ngày đi
                </label>
            ...
            <div className="part3">
              ...
              <div className="form-field">
                ...
                <DatePicker
                  ...
                  format="DD-MM-YYYY"
                  disabledDate={disabledDate}
                  onChange={handleOnchangeTimeTab2}
                />
                <label htmlFor="name" className="form-label">
                  Ngày đi
                </label>
              ...
              <div className="part3">
                ...
                <div className="form-field">
                  ...
                  <DatePicker
                    ...
                    format="DD-MM-YYYY"
                    disabledDate={disabledDate}
                    onChange={handleOnchangeTimeTab3}
                  />
                  <label htmlFor="name" className="form-label">
                    Ngày đi
                  </label>
