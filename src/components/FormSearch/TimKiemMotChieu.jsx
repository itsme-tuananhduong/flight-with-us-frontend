...
function TimKiemMotChieu({setSendData}) {
  ...
  const handleOnchangeTimeTab = (date, dateString) => setTimeTab(dateString);
    ...
    <Fragment>
      <div className="formSearch-main active">
          ...
          <div className="part2">
            <div className="form-field">
              ...
              <DatePicker
                ...
                onChange={handleOnchangeTimeTab}
              />
              <label htmlFor="name" className="form-label">
                Ngày đi
              </label>
        ...
        <div className="submit-form">
          ...
          <span className="submit-form-btn" onClick={handleData}>Tìm Kiếm</span>
        </div>
      </div>
    </Fragment>
  );
...
export default TimKiemMotChieu;
